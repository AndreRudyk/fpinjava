This repository contains code, exercises and solutions from the book "Functional Programming in Java" by Saumont Pierre-Yves. Along with the book itself, it's the
